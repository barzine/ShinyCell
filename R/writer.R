...
wrSVfix <- function() {
  glue::glue('### Useful stuff \n',
             ...
             '  }} \n',
             '  if(inpsplit){{ \n',
             '    ggOut = ggOut + facet_wrap(~ split)+theme_split() \n',
             '  }} \n',
             '  return(ggOut) \n',
             '}} \n',
             ' \n',
             ...
             '                     inpH5, inpGene, \n',
             '                     inpsiz, inpcol, inpord, inpfsz, inpasp, inptxt,inpsplit=FALSE,splitBy){{ \n',
             '  if(is.null(inpsub1)){{inpsub1 = inpConf$UI[1]}} \n',
             '  # Prepare ggData \n',
             '  if(!inpsplit) {{  \n',
             '    ggData = inpMeta[, c(inpConf[UI == inpdrX]$ID, inpConf[UI == inpdrY]$ID, \n',
             ...
             '}}else{{ \n',
             '    ggData = inpMeta[, c(inpConf[UI == inpdrX]$ID, inpConf[UI == inpdrY]$ID, \n', 
             '                      inpConf[UI == inpsub1]$ID,inpConf[UI == splitBy]$ID),  \n',
             '                     with = FALSE] \n',
             ...
             '    ggOut = ggOut + coord_fixed() \n',
             '  }} \n',
             ' if(inpsplit) {{ ggOut = ggOut +facet_wrap(~split) +theme_split() }} \n',
             '  return(ggOut) \n',
             '}} \n',
             ' \n',
             ...
             '                     inpsplit=FALSE, splitBy, inpRownumb=3, inpColnumb=2 ){{ \n',
             '  if(is.null(inpsub1)){{inpsub1 = inpConf$UI[1]}} \n',
             '  # Prepare ggData \n',
             '  if(!inpsplit){{ \n',
             '    ggData = inpMeta[, c(inpConf[UI == inp1]$ID, inpConf[UI == inpsub1]$ID), \n',
             ...
             '  }}else{{ \n',
             '    ggData = inpMeta[, c(inpConf[UI == inp1]$ID, inpConf[UI == inpsub1]$ID, \n',
             '                     inpConf[UI == splitBy]$ID), \n',
             '                     with = FALSE] \n', 
             '    colnames(ggData) = c("X", "sub", "split") \n',
             '  }} \n',
             '  \n',
             ...
             '                         inpConf[UI == inpsub1]$ID, inpConf[UI == splitBy]$ID), \n',
             '                     with = FALSE] \n', 
             '    colnames(ggData) = c("X", "grp", "sub", "split") \n',
             '  }} \n',
             '  if(length(inpsub2) != 0 & length(inpsub2) != nlevels(ggData$sub)){{ \n',
             '    ggData = ggData[sub %in% inpsub2] \n',
             '  }} \n',
             ...
             '  }}else{{ \n',
             '    ggData = ggData[, .(nCells = .N), by = c("X", "grp","split")] \n',
             '    ggData = ggData[, {{tot = sum(nCells) \n',
             '                        .SD[,.(pctCells = 100 * sum(nCells) / tot, \n',
             '                               nCells = nCells), by = "grp"]}}, by = c("X","split")] \n',
             '  }}\n',
             '  \n',
             '  # Do factoring \n',
             ...
             '}} \n',
             ' \n',
             '# Plot gene expression dotplot / heatmap \n',
             'scDotHeat <- function(inpConf, inpMeta, inp, inpGrp, inpPlt, \n',
...
wrSVmain <- function(prefix, subst = "") {
  glue::glue('optCrt="{{ option_create: function(data,escape) {{return(\'<div class=\\"create\\"><strong>\' + \'</strong></div>\');}} }}" \n',
             ...
             '             input${prefix}a1fsz, input${prefix}a1asp, input${prefix}a1txt,input${prefix}a1sub1cond, input${prefix}a1sub1condGrp) \n',
             '  }}) \n',
             ...
             '{subst}                       choices = sub, selected = sub) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}a2sub1Cond.ui <- renderUI({{ \n',
             '{subst}    selectInput("{prefix}a2sub1condGrp", "Split by following cell information:", \n',
             '{subst}                choices = {prefix}conf[grp == TRUE]$UI, \n',
             '{subst}                selected = NULL) \n',
             '{subst}  }}) \n',
             ...
             '             input${prefix}a2fsz, input${prefix}a2asp, input${prefix}a2txt, input${prefix}a2lab1,input${prefix}a2sub1cond, input${prefix}a2sub1condGrp) \n',
             '  }}) \n',
             ...
             '             input${prefix}a2fsz, input${prefix}a2asp, input${prefix}a2txt, input${prefix}a2lab2,input${prefix}a2sub1cond, input${prefix}a2sub1condGrp) \n',
             '  }}) \n',
             ...
             '{subst}                       choices = sub, selected = sub) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}a3sub1Cond.ui <- renderUI({{ \n',
             '{subst}    selectInput("{prefix}a3sub1condGrp", "Split by following cell information:", \n',
             '{subst}                choices = {prefix}conf[grp == TRUE]$UI, \n',
             '{subst}                selected = NULL) \n',
             '{subst}  }}) \n',
             ...
             '             input${prefix}a3fsz, input${prefix}a3asp, input${prefix}a3txt,input${prefix}a3sub1cond, input${prefix}a3sub1condGrp) \n',
             '  }}) \n',
             ...
             '{subst}                       choices = sub, selected = sub) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}b2sub1Cond.ui <- renderUI({{ \n',
             '{subst}    selectInput("{prefix}b2sub1condGrp", "Split by following cell information:", \n',
             '{subst}                choices = {prefix}conf[grp == TRUE]$UI, \n',
             '{subst}                selected = NULL) \n',
             '{subst}  }}) \n',
             ...
             '             input${prefix}b2fsz, input${prefix}b2asp, input${prefix}b2txt, input${prefix}b2sub1cond , input${prefix}b2sub1condGrp ) \n',
             '  }}) \n',
             ...
             '{subst}                       choices = sub, selected = sub) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}c1sub1Cond.ui <- renderUI({{ \n',
             '{subst}    tagList( \n',
             '{subst}      selectInput("{prefix}c1sub1condGrp", "Split by following cell information:", \n',
             '{subst}                  choices = {prefix}conf[grp == TRUE]$UI, \n',
             '{subst}                  selected = NULL), \n',
             '{subst}      checkboxInput("{prefix}c1sub1condGrpPanel", "Change number of rows/columns of the figure",FALSE), \n',
             '{subst}      conditionalPanel( \n',
             '{subst}        condition = "input.{prefix}c1sub1condGrpPanel % 2 == 1", uiOutput("{prefix}c1sub1Condgrpminmax.ui")) \n',
             '{subst}    ) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}c1sub1Condgrpminmax.ui <- renderUI({{ \n',
             '{subst}    maxNumbCat = length(strsplit({prefix}conf[UI == input${prefix}c1sub1condGrp]$fID, "\\\\|")[[1]]) \n',
             '{subst}    tagList( \n',
             '{subst}      numericInput("{prefix}c1Colnumb","Number of columns for the figure",1, min=1, \n',
             '{subst}                  max=maxNumbCat,step=1), \n',
             '{subst}      numericInput("{prefix}c1Rownumb","Number of rows for the figure", 2, min=1, \n',
             '{subst}                   max=maxNumbCat,step=1) \n',
             '{subst}     ) \n',
             '{subst}  }}) \n',
             ...
             '             input${prefix}c1siz, input${prefix}c1fsz,input${prefix}c1sub1cond , input${prefix}c1sub1condGrp,input${prefix}c1Rownumb, input${prefix}c1Colnumb) \n',
             '  }}) \n',
             ...
             '{subst}                       choices = sub, selected = sub) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}c2sub1Cond.ui <- renderUI({{ \n',
             '{subst}    tagList( \n',
             '{subst}    selectInput("{prefix}c2sub1condGrp", "Split by following cell information:", \n',
             '{subst}                choices = {prefix}conf[grp == TRUE]$UI, \n',
             '{subst}                selected = NULL), \n',
             '{subst}      checkboxInput("{prefix}c2sub1condGrpPanel", "Change number of rows/columns of the figure",FALSE), \n',
             '{subst}      conditionalPanel( \n',
             '{subst}        condition = "input.{prefix}c2sub1condGrpPanel % 2 == 1", uiOutput("{prefix}c2sub1Condgrpminmax.ui")) \n',
             '{subst}    ) \n',
             '{subst}  }}) \n',
             '{subst}  output${prefix}c2sub1Condgrpminmax.ui <- renderUI({{ \n',
             '{subst}    maxNumbCat = length(strsplit({prefix}conf[UI == input${prefix}c2sub1condGrp]$fID, "\\\\|")[[1]]) \n',
             '{subst}    tagList( \n',
             '{subst}      numericInput("{prefix}c2Colnumb","Number of columns for the figure",1, min=1, \n',
             '{subst}                  max=maxNumbCat,step=1), \n',
             '{subst}      numericInput("{prefix}c2Rownumb","Number of rows for the figure", 2, min=1, \n',
             '{subst}                   max=maxNumbCat,step=1) \n',
             '{subst}     ) \n',
             '{subst}  }}) \n',
             ...
             '         input${prefix}c2typ, input${prefix}c2flp, input${prefix}c2fsz,input${prefix}c2sub1cond , input${prefix}c2sub1condGrp,input${prefix}c2Rownumb, input${prefix}c2Colnumb) \n',
             '}}) \n',
             ...
             '    scDotHeat({prefix}conf, {prefix}meta, input${prefix}d1inp, input${prefix}d1grp, input${prefix}d1plt, \n',
             ...
             '      plot = scDotHeat({prefix}conf, {prefix}meta, input${prefix}d1inp, input${prefix}d1grp, input${prefix}d1plt, \n',
             '                        input${prefix}d1sub1, input${prefix}d1sub2, "{prefix}gexpr.h5", {prefix}gene, \n',
             '                        input${prefix}d1scl, input${prefix}d1row, input${prefix}d1col, \n',
...
wrUImain <- function(prefix, subst = "", ptsiz = "1.25") {
  glue::glue('  ### Tab1.a1: cellInfo vs geneExpr on dimRed \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a1togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a2togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             '{subst}          condition = "input.{prefix}a2togCond % 2 == 1", \n',
             '{subst}          checkboxInput("{prefix}a2sub1cond", "Split plots based on cell information",FALSE), \n',
             '{subst}          conditionalPanel( \n',
             '{subst}             condition = "input.{prefix}a2sub1cond % 2 == 1", uiOutput("{prefix}a2sub1Cond.ui")) \n',
             '{subst}        ) \n',
             '      )  # End of column (6 space) \n',
             '    ),   # End of fluidRow (4 space) \n',
             '    fluidRow( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}a3togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             '{subst}          condition = "input.{prefix}a3togCond % 2 == 1", \n',
             '{subst}          checkboxInput("{prefix}a3sub1cond", "Split plots based on cell information",FALSE), \n',
             '{subst}          conditionalPanel( \n',
             '{subst}             condition = "input.{prefix}a3sub1cond % 2 == 1", uiOutput("{prefix}a3sub1Cond.ui")) \n',
             '{subst}        ) \n',
             '      )  # End of column (6 space) \n',
             '    ),   # End of fluidRow (4 space) \n',
             '    fluidRow( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}b2togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             '{subst}          condition = "input.{prefix}b2togCond % 2 == 1", \n',
             '{subst}          checkboxInput("{prefix}b2sub1cond", "Split plots based on cell information",FALSE), \n',
             '{subst}          conditionalPanel( \n',
             '{subst}             condition = "input.{prefix}b2sub1cond % 2 == 1", uiOutput("{prefix}b2sub1Cond.ui")) \n',
             '{subst}        ) \n',
             '      )  # End of column (6 space) \n',
             '    ),   # End of fluidRow (4 space) \n',
             '   fluidRow( \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        12{subst}, actionButton("{prefix}c1togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             '{subst}          condition = "input.{prefix}c1togCond % 2 == 1", \n',
             '{subst}          checkboxInput("{prefix}c1sub1cond", "Split plots based on cell information",FALSE), \n',
             '{subst}          conditionalPanel( \n',
             '{subst}             condition = "input.{prefix}c1sub1cond % 2 == 1", uiOutput("{prefix}c1sub1Cond.ui")) \n',
             '{subst}        ) \n',
             '      )  # End of column (6 space) \n',
             '    ),   # End of fluidRow (4 space) \n',
             ...
             '    fluidRow( \n',
             '      column( \n',
             '        6{subst}, actionButton("{prefix}c2togCond", "Toggle controls for splitting (by condition"), \n',
             '{subst}        conditionalPanel( \n',
             '{subst}          condition = "input.{prefix}c2togCond % 2 == 1", \n',
             '{subst}          checkboxInput("{prefix}c2sub1cond", "Split plots based on cell information",FALSE), \n',
             '{subst}          conditionalPanel( \n',
             '{subst}             condition = "input.{prefix}c2sub1cond % 2 == 1", uiOutput("{prefix}c2sub1Cond.ui")) \n',
             '{subst}        ) \n',
             '      ), # End of column (6 space) \n',
             '    ),   # End of fluidRow \n',
             ...
             '  tabPanel( \n',
             '    HTML("Dotplot / Heatmap"), \n',
             '    h4("Gene expression dotplot / heatmap"), \n',
             ...
             '          helper(type = "inline", size = "m", fade = TRUE, \n',
             '                 title = "List of genes to plot on dotplot / heatmap", \n',
             ...
             '                 content = c("Select categorical cell information to group cells by", \n',
             '                             "- Single cells are grouped by this categorical covariate", \n',
             '                             "- Plotted as the X-axis of the dotplot / heatmap")), \n',
             '        radioButtons("{prefix}d1plt", "Plot type:", \n',
             '                     choices = c("Dotplot", "Heatmap"), \n',
...
wrUIend <- function(footnote) {
  ...
  glue::glue('   \n',
             ...
             'br(), \n',
             'p({f0}), \n',
             'p(em("This webpage was made using a modified version of"), a("ShinyCell", \n', 
             '  href = "https://github.com/barzine/ShinyCell",target="_blank")), \n',
             'br(),br(),br(),br(),br() \n',
             '))) \n',
             ' \n',
             ' \n',
