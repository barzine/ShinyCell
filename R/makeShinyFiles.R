...
makeShinyFiles <- function(
  ...
  if(class(obj)[1] == "Seurat"){
    # Seurat Object
    if(is.na(gex.assay[1])){gex.assay = "RNA"} ## manual modification to incorporate zpohk:Seurat-V5 (https://github.com/SGDDNB/ShinyCell/commit/64871265ad6f88600ea6c08d0022fadbabac8641)
  ...
  if(class(obj)[1] == "Seurat"){
    # Seurat Object  ## manual modification to incorporate zpohk:Seurat-V5 (https://github.com/SGDDNB/ShinyCell/commit/64871265ad6f88600ea6c08d0022fadbabac8641)
 if(class(obj@assays[[gex.assay[1]]]) == "Assay5"){
      # Seurat v5
